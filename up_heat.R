...
png(file = "ivory_heat.png", units="in", width=10, height=5, res=600)
...
png(file = "reptile_heat.png", units="in", width=10, height=5, res=600)
...
png(file = "bird_heat.png", units="in", width=10, height=5, res=600)
